...
import type { FloatingElementAlignment, UseAnchoredPositionOptions } from '../../hooks/useAnchoredPosition'
import { useOverlayRegistry } from '@helpwave/hightide-utils/hooks'
import { useTransitionState } from '../../hooks/useTransitionState'
import type { TooltipConfig } from '../../global-contexts/hightide-config/HightideConfigContext'
import { useHightideConfig } from '../../global-contexts/hightide-config/HightideConfigContext'
