...
import { useChangingNumber } from '@helpwave/hightide-utils'
import type { Curve } from '@helpwave/hightide-utils'
import { CurveBuilderUtil } from '@helpwave/hightide-utils'
